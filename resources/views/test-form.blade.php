...
<div class="container mt-5">
    ...
    <form method="POST" action="{{ route('pendaftaran.store') }}">
        ...
        <div class="mb-3">
            <label>NISN</label>
            <input type="text" name="nisn" class="form-control" value="12345678" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="tanggal_lahir" class="form-control" value="2005-01-01" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="tahun_lulus" class="form-control" value="2023" required>
        </div>
        <div class="mb-3">
            <label>Nilai Matematika</label>
            <input type="number" name="nilai_matematika" class="form-control" value="80" required>
        </div>
        <div class="mb-3">
            <label>Nilai Bahasa Indonesia</label>
            <input type="number" name="nilai_bahasa_indonesia" class="form-control" value="85" required>
        </div>
        <div class="mb-3">
